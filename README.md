...
`YOUR_INSTANCE_TYPE` refers to an AWS instance type. For this example, I opted for `t2.medium`. It was removed from the example above because it involves cost, so it shoulnd't be copy/pasted without thinking :)
